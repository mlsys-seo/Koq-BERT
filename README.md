...
### 해당 기술은 솔트룩스 AI에서 학습한 모델을 “WiseKB:빅데이터 이해 기반 자가학습형 지식베이스 및 추론 기술 개발”의 연구중 hanyang 서지원교수님 연구실에서 - BERT 모델의 추론성능 개선을 위한 Kernel Fusion 및 FP16 Quantization 적용한 기술입니다.
